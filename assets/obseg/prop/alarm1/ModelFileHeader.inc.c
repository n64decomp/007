...
/*
    ...
    ModelFileHeader alarm1_header = {0, $skeleton_standard_object, 0, 0, 1, 304.6402, 0, 2, 0};
#else
    ModelFileHeader alarm1_header = {0, $skeleton_standard_object, 0, 0, 1, 304.6402, 0, 2};
#endif
*/
