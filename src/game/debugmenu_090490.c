...
/* 0C5010 7F0904E0 3C038003 */  lui   $v1, %hi(debug_unknown) # $v1, 0x8003
/* 0C5014 7F0904E4 3C048003 */  lui   $a0, %hi(debug_freeze_processing) # $a0, 0x8003
...
/* 0C5028 7F0904F8 3C018003 */  lui   $at, %hi(debug_render_raster) # $at, 0x8003
...
/* 0C5054 7F090524 3C038003 */  lui   $v1, %hi(debug_unknown) # $v1, 0x8003
/* 0C5058 7F090528 3C048003 */  lui   $a0, %hi(debug_freeze_processing) # $a0, 0x8003
...
/* 0C506C 7F09053C 3C018003 */  lui   $at, %hi(debug_render_raster) # $at, 0x8003
...
/* 0C5098 7F090568 3C038003 */  lui   $v1, %hi(debug_unknown) # $v1, 0x8003
/* 0C509C 7F09056C 3C048003 */  lui   $a0, %hi(debug_freeze_processing) # $a0, 0x8003
...
/* 0C50B0 7F090580 3C018003 */  lui   $at, %hi(debug_render_raster) # $at, 0x8003
...
/* 0C51BC 7F09068C 3C018003 */  lui   $at, %hi(debug_unknown) # $at, 0x8003
...
/* 0C51E8 7F0906B8 3C048003 */  lui   $a0, %hi(debug_limit_controller_input) # $a0, 0x8003
...
/* 0C5210 7F0906E0 3C048003 */  lui   $a0, %hi(debug_limit_controller_input) # $a0, 0x8003
...
/* 0C5238 7F090708 3C048003 */  lui   $a0, %hi(debug_limit_controller_input) # $a0, 0x8003
...
/* 0C5260 7F090730 3C048003 */  lui   $a0, %hi(debug_limit_controller_input) # $a0, 0x8003
...
/* 0C5308 7F0907D8 3C018003 */  lui   $at, %hi(debug_unknown) # $at, 0x8003
...
/* 0C531C 7F0907EC 3C018003 */  lui   $at, %hi(debug_unknown) # $at, 0x8003
...
/* 0C5330 7F090800 3C018003 */  lui   $at, %hi(debug_unknown) # $at, 0x8003
...
/* 0C5344 7F090814 3C018003 */  lui   $at, %hi(debug_unknown) # $at, 0x8003
...
/* 0C5380 7F090850 3C018003 */  lui   $at, %hi(debug_unknown) # $at, 0x8003
...
/* 0C5394 7F090864 3C018003 */  lui   $at, %hi(debug_unknown) # $at, 0x8003
...
/* 0C53C0 7F090890 3C018003 */  lui   $at, %hi(debug_unknown) # $at, 0x8003
...
debug_dodrawbg:
/* 0C54E8 7F0909B8 3C028003 */  lui   $v0, %hi(debug_do_draw_bg) # $v0, 0x8003
...
debug_dodrawobj:
/* 0C5500 7F0909D0 3C028003 */  lui   $v0, %hi(debug_do_draw_obj) # $v0, 0x8003
...
debug_intropos:
/* 0C5788 7F090C58 3C198003 */  lui   $t9, %hi(debug_render_raster) # $t9, 0x8003
...
debug_worldpos:
/* 0C57A8 7F090C78 3C088003 */  lui   $t0, %hi(debug_render_raster) # $t0, 0x8003
...
/* 0C57D8 7F090CA8 3C028003 */  lui   $v0, %hi(D_80037004) # $v0, 0x8003
...
/* 0C5824 7F090CF4 3C028003 */  lui   $v0, %hi(D_80037004) # $v0, 0x8003
...
/* 0C5850 7F090D20 3C018003 */  lui   $at, %hi(debug_unknown) # $at, 0x8003
...
/* 0C58F4 7F090DC4 3C018003 */  lui   $at, %hi(debug_unknown) # $at, 0x8003
...
/* 0C5908 7F090DD8 3C018003 */  lui   $at, %hi(debug_unknown) # $at, 0x8003
...
/* 0C599C 7F090E6C 3C018003 */  lui   $at, %hi(debug_unknown) # $at, 0x8003
