...
/* 0C5C58 7F091128 3C0F8003 */   lui   $t7, %hi(D_80037054) # $t7, 0x8003
...
/* 0C5C90 7F091160 3C018003 */  lui   $at, %hi(D_80037050) # $at, 0x8003
...
.L7F091170:
/* 0C5CA0 7F091170 3C018003 */  lui   $at, %hi(D_80037050) # $at, 0x8003
...
/* 0C5CE0 7F0911B0 3C028003 */  lui   $v0, %hi(D_80037044) # $v0, 0x8003
...
/* 0C5DCC 7F09129C 3C038003 */  lui   $v1, %hi(D_80037038) # $v1, 0x8003
...
/* 0C5DDC 7F0912AC 3C018003 */  lui   $at, %hi(D_80037050) # $at, 0x8003
...
.L7F0912D8:
/* 0C5E08 7F0912D8 3C028003 */  lui   $v0, %hi(D_80037044) # $v0, 0x8003
...
/* 0C5E50 7F091320 3C018003 */  lui   $at, %hi(D_80037050) # $at, 0x8003
...
.L7F091334:
/* 0C5E64 7F091334 3C038003 */  lui   $v1, %hi(D_80037038) # $v1, 0x8003
...
/* 0C5E74 7F091344 3C028003 */  lui   $v0, %hi(D_80037044) # $v0, 0x8003
...
/* 0C5EB8 7F091388 3C018005 */  lui   $at, %hi(D_80055850) # $at, 0x8005
...
/* 0C5F54 7F091424 3C018003 */  lui   $at, %hi(D_8003703C) # $at, 0x8003
/* 0C5F58 7F091428 E420703C */  swc1  $f0, %lo(D_8003703C)($at)
/* 0C5F5C 7F09142C 3C038003 */  lui   $v1, %hi(D_80037038) # $v1, 0x8003
/* 0C5F60 7F091430 24637038 */  addiu $v1, %lo(D_80037038) # addiu $v1, $v1, 0x7038
/* 0C5F64 7F091434 3C018005 */  lui   $at, %hi(D_80055854) # $at, 0x8005
...
/* 0C5F7C 7F09144C 3C018003 */  lui   $at, %hi(D_80037040) # $at, 0x8003
/* 0C5F80 7F091450 E4207040 */  swc1  $f0, %lo(D_80037040)($at)
/* 0C5F84 7F091454 3C028003 */  lui   $v0, %hi(D_80037044) # $v0, 0x8003
/* 0C5F88 7F091458 24427044 */  addiu $v0, %lo(D_80037044) # addiu $v0, $v0, 0x7044
/* 0C5F8C 7F09145C 3C018005 */  lui   $at, %hi(D_80055858) # $at, 0x8005
...
/* 0C5FA4 7F091474 3C018003 */  lui   $at, %hi(D_80037048) # $at, 0x8003
/* 0C5FA8 7F091478 E4207048 */  swc1  $f0, %lo(D_80037048)($at)
/* 0C5FAC 7F09147C 3C028003 */  lui   $v0, %hi(D_80037044) # $v0, 0x8003
/* 0C5FB0 7F091480 24427044 */  addiu $v0, %lo(D_80037044) # addiu $v0, $v0, 0x7044
/* 0C5FB4 7F091484 3C018005 */  lui   $at, %hi(D_8005585C) # $at, 0x8005
...
/* 0C5FCC 7F09149C 3C048003 */  lui   $a0, %hi(D_8003704C) # $a0, 0x8003
...
/* 0C601C 7F0914EC 3C018003 */  lui   $at, %hi(D_80037054) # $at, 0x8003
...
/* 0C6058 7F091528 3C028008 */  lui   $v0, %hi(dword_CODE_bss_80079E20) # $v0, 0x8008
...
/* 0C6160 7F091630 3C018005 */  lui   $at, %hi(D_80055860) # $at, 0x8005
