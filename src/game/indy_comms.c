...
void load_resource_on_indy(s32 arg1) {
    ...
    {
        // Node 1
        post_indyrescmd_req_filename_size(0x400000);
        response_indyrescmd_1_8_2(&sp20, &sp1C, &sp18, arg1);
    }
    // Node 2
    return;
}
...
/* 104AE4 7F0CFFB4 0FC342E9 */  jal   post_indyrescmd_req_filename_size
...
/* 104AF8 7F0CFFC8 0FC345FF */  jal   response_indyrescmd_1_8_2
...
void indy_send_capture_data(s32 arg1, ? arg2) {
    ...
    {
        // Node 1
        post_indyrescmd_send_capture_data(arg2, arg1);
        response_indyrescmd_1_A_2(&sp1C);
    }
    // Node 2
    return;
}
...
/* 104B2C 7F0CFFFC 0FC3431A */  jal   post_indyrescmd_send_capture_data
/* 104B30 7F0D0000 8FA60024 */   lw    $a2, 0x24($sp)
/* 104B34 7F0D0004 0FC34619 */  jal   response_indyrescmd_1_A_2
...
/* 104B74 7F0D0044 0FC3462B */  jal   response_indyrescmd_1_10_2
...
void check_file_exported(s32 arg1, ? arg2) {
    ...
    {
        // Node 1
        post_indyrescmd_game_prof_sendfile(arg2, arg1);
        response_indyrescmd_1_E_2(&sp1C);
    }
    // Node 2
    return;
}
...
/* 104BA8 7F0D0078 0FC34374 */  jal   post_indyrescmd_game_prof_sendfile
/* 104BAC 7F0D007C 8FA60024 */   lw    $a2, 0x24($sp)
/* 104BB0 7F0D0080 0FC34642 */  jal   response_indyrescmd_1_E_2
