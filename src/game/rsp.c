...
/* 104938 7F0CFE08 3C018005 */  lui   $at, %hi(D_8004E9E4)
...
/* 10494C 7F0CFE1C 3C038005 */  lui   $v1, %hi(fast3d_related_array)
...
/* 1049B8 7F0CFE88 3C0D8009 */  lui   $t5, %hi(dword_CODE_bss_8008D770) 
