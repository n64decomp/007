...
/* 035854 7F000D24 3C018003 */  lui   $at, %hi(current_menu) # $at, 0x8003
/* 035858 7F000D28 AC22A8C0 */  sw    $v0, %lo(current_menu)($at)
/* 03585C 7F000D2C 3C018003 */  lui   $at, %hi(maybe_prev_menu) # $at, 0x8003
/* 035860 7F000D30 AC22A8C8 */  sw    $v0, %lo(maybe_prev_menu)($at)
/* 035864 7F000D34 3C018003 */  lui   $at, %hi(screen_size) # $at, 0x8003
/* 035868 7F000D38 AC20A940 */  sw    $zero, %lo(screen_size)($at)
/* 03586C 7F000D3C 24030001 */  li    $v1, 1
/* 035870 7F000D40 3C018003 */  lui   $at, %hi(spectrum_related_flag) # $at, 0x8003
/* 035874 7F000D44 AC23A944 */  sw    $v1, %lo(spectrum_related_flag)($at)
/* 035878 7F000D48 3C018003 */  lui   $at, %hi(is_emulating_spectrum) # $at, 0x8003
/* 03587C 7F000D4C AC20A948 */  sw    $zero, %lo(is_emulating_spectrum)($at)
/* 035880 7F000D50 3C018003 */  lui   $at, %hi(folder_selection_screen_option_icon) # $at, 0x8003
/* 035884 7F000D54 AC20A918 */  sw    $zero, %lo(folder_selection_screen_option_icon)($at)
/* 035888 7F000D58 3C018003 */  lui   $at, %hi(folder_selected_for_deletion) # $at, 0x8003
/* 03588C 7F000D5C AC22A91C */  sw    $v0, %lo(folder_selected_for_deletion)($at)
/* 035890 7F000D60 3C018003 */  lui   $at, %hi(folder_selected_for_deletion_choice) # $at, 0x8003
/* 035894 7F000D64 AC23A920 */  sw    $v1, %lo(folder_selected_for_deletion_choice)($at)
/* 035898 7F000D68 3C018003 */  lui   $at, %hi(tab_1_highlight) # $at, 0x8003
/* 03589C 7F000D6C AC20A8DC */  sw    $zero, %lo(tab_1_highlight)($at)
/* 0358A0 7F000D70 3C018003 */  lui   $at, %hi(tab_2_highlight) # $at, 0x8003
/* 0358A4 7F000D74 AC20A8E0 */  sw    $zero, %lo(tab_2_highlight)($at)
/* 0358A8 7F000D78 3C0E8003 */  lui   $t6, %hi(prev_keypresses) # $t6, 0x8003
/* 0358AC 7F000D7C 8DCEA934 */  lw    $t6, %lo(prev_keypresses)($t6)
/* 0358B0 7F000D80 3C018003 */  lui   $at, %hi(tab_3_highlight) # $at, 0x8003
/* 0358B4 7F000D84 AC20A8E4 */  sw    $zero, %lo(tab_3_highlight)($at)
/* 0358B8 7F000D88 27BDFFE8 */  addiu $sp, $sp, -0x18
/* 0358BC 7F000D8C 3C018003 */  lui   $at, %hi(maybe_is_in_menu) # $at, 0x8003
...
/* 0358CC 7F000D9C 3C028003 */  lui   $v0, %hi(menu_update) # $v0, 0x8003
...
.L7F000DAC:
/* 0358DC 7F000DAC 3C028003 */  lui   $v0, %hi(menu_update) # $v0, 0x8003
...
/* 035904 7F000DD4 3C018003 */  lui   $at, %hi(ptr_logo_and_walletbond_DL) # $at, 0x8003
...
/* 03591C 7F000DEC 3C038003 */  lui   $v1, %hi(ptr_menu_videobuffer) # $v1, 0x8003
...
/* 035938 7F000E08 3C018003 */  lui   $at, %hi(ptr_folder_object_instance) # $at, 0x8003
/* 03593C 7F000E0C AC20A95C */  sw    $zero, %lo(ptr_folder_object_instance)($at)
/* 035940 7F000E10 3C018003 */  lui   $at, %hi(set0_never_used) # $at, 0x8003
/* 035944 7F000E14 AC20A960 */  sw    $zero, %lo(set0_never_used)($at)
/* 035948 7F000E18 3C018003 */  lui   $at, %hi(set0_never_used_0) # $at, 0x8003
/* 03594C 7F000E1C AC20A964 */  sw    $zero, %lo(set0_never_used_0)($at)
/* 035950 7F000E20 3C018003 */  lui   $at, %hi(D_8002A968) # $at, 0x8003
