...
/* 00C16C 7000B56C 3C058003 */  lui   $a1, %hi(aJoy_c_debug) # $a1, 0x8003
...
/* 00C20C 7000B60C 3C018002 */  lui   $at, %hi(D_80026918) # $at, 0x8002
...
/* 00C358 7000B758 3C188006 */  lui   $t8, %hi(player1_controllerstatus) # $t8, 0x8006
...
/* 00C398 7000B798 3C0C8006 */  lui   $t4, %hi(player1_controller_packet) # $t4, 0x8006
...
/* 00C50C 7000B90C 3C078002 */  lui   $a3, %hi(num_controller_plugged_in_flags_0) # $a3, 0x8002
/* 00C510 7000B910 3C068002 */  lui   $a2, %hi(controller_1_rumble_inserted) # $a2, 0x8002
...
.L7000B920:
/* 00C520 7000B920 3C198002 */  lui   $t9, %hi(num_controller_plugged_in_flags) # $t9, 0x8002
...
/* 00C53C 7000B93C 3C098006 */  lui   $t1, %hi(player1_controllerstatus) # $t1, 0x8006
...
/* 00C58C 7000B98C 3C078002 */  lui   $a3, %hi(num_controller_plugged_in_flags_0) # $a3, 0x8002
/* 00C590 7000B990 24E768D4 */  addiu $a3, %lo(num_controller_plugged_in_flags_0) # addiu $a3, $a3, 0x68d4
/* 00C594 7000B994 3C068002 */  lui   $a2, %hi(controller_1_rumble_inserted) # $a2, 0x8002
...
/* 00C69C 7000BA9C 3C108002 */  lui   $s0, %hi(controller_1_rumble_duration) # $s0, 0x8002
/* 00C6A0 7000BAA0 3C118002 */  lui   $s1, %hi(controller_1_rumble_state) # $s1, 0x8002
/* 00C6A4 7000BAA4 3C148002 */  lui   $s4, %hi(controller_1_rumble_pulse) # $s4, 0x8002
...
/* 00C6E4 7000BAE4 3C188006 */  lui   $t8, %hi(player1_controller_packet) # $t8, 0x8006
...
/* 00C704 7000BB04 3C198002 */   lui   $t9, %hi(controller_1_rumble_inserted) # $t9, 0x8002
...
/* 00C72C 7000BB2C 3C088002 */   lui   $t0, %hi(controller_1_rumble_inserted) # $t0, 0x8002
...
/* 00C920 7000BD20 3C048006 */   lui   $a0, %hi(dword_CODE_bss_8006512C) # $a0, 0x8006
/* 00C924 7000BD24 3C058006 */  lui   $a1, %hi(dword_CODE_bss_8006530C) # $a1, 0x8006
...
/* 00C934 7000BD34 3C018006 */  lui   $at, %hi(dword_CODE_bss_80065314) # $at, 0x8006
/* 00C938 7000BD38 3C048006 */  lui   $a0, %hi(dword_CODE_bss_8006512C) # $a0, 0x8006
...
.L7000BD48:
/* 00C948 7000BD48 3C048006 */  lui   $a0, %hi(controller_input_index) # $a0, 0x8006
...
/* 00C954 7000BD54 3C028002 */  lui   $v0, %hi(ptr_to_tlb_ramrom_record) # $v0, 0x8002
/* 00C958 7000BD58 8C426928 */  lw    $v0, %lo(ptr_to_tlb_ramrom_record)($v0)
/* 00C95C 7000BD5C 3C048006 */  lui   $a0, %hi(controller_input_index) # $a0, 0x8006
...
/* 00C9E4 7000BDE4 3C038002 */  lui   $v1, %hi(D_800268CC) # $v1, 0x8002
...
/* 00CA40 7000BE40 3C038002 */  lui   $v1, %hi(D_800268CC) # $v1, 0x8002
...
.L7000BE58:
/* 00CA58 7000BE58 3C038002 */  lui   $v1, %hi(D_800268CC) # $v1, 0x8002
/* 00CA5C 7000BE5C 246368CC */  addiu $v1, %lo(D_800268CC) # addiu $v1, $v1, 0x68cc
/* 00CA60 7000BE60 8C6D0000 */  lw    $t5, ($v1)
/* 00CA64 7000BE64 3C0E8002 */  lui   $t6, %hi(D_8002691C) # $t6, 0x8002
...
/* 00CA90 7000BE90 3C058006 */   lui   $a1, %hi(controller_input_index) # $a1, 0x8006
/* 00CA94 7000BE94 3C018002 */  lui   $at, %hi(D_800268C8) # $at, 0x8002
...
/* 00CAE4 7000BEE4 3C048002 */  lui   $a0, %hi(D_80026920) # $a0, 0x8002
...
/* 00CB08 7000BF08 3C058006 */  lui   $a1, %hi(controller_input_index) # $a1, 0x8006
...
/* 00CB2C 7000BF2C 3C058006 */  lui   $a1, %hi(controller_input_index) # $a1, 0x8006
...
/* 00CBFC 7000BFFC 3C018002 */  lui   $at, %hi(D_800268C8) # $at, 0x8002
/* 00CC00 7000C000 AC3968C8 */  sw    $t9, %lo(D_800268C8)($at)
/* 00CC04 7000C004 3C018002 */  lui   $at, %hi(D_80026970) # $at, 0x8002
...
/* 00CC18 7000C018 3C098002 */   lui   $t1, %hi(pl1_controller_failure_lr) # $t1, 0x8002
/* 00CC1C 7000C01C 3C048002 */  lui   $a0, %hi(pl1_controller_failure_ud) # $a0, 0x8002
/* 00CC20 7000C020 3C058002 */  lui   $a1, %hi(pl1_controller_failure_held) # $a1, 0x8002
/* 00CC24 7000C024 3C038002 */  lui   $v1, %hi(pl1_controller_failure_pressed) # $v1, 0x8002
/* 00CC28 7000C028 3C0A8002 */  lui   $t2, %hi(D_80026970) # $t2, 0x8002
...
/* 00CCD4 7000C0D4 3C018002 */  lui   $at, %hi(D_80026970) # $at, 0x8002
...
/* 00CD0C 7000C10C 3C198002 */   lui   $t9, %hi(num_controller_plugged_in_flags) # $t9, 0x8002
/* 00CD10 7000C110 933968D0 */  lbu   $t9, %lo(num_controller_plugged_in_flags)($t9)
/* 00CD14 7000C114 3C0B8002 */  lui   $t3, %hi(pl1_controller_failure_lr) # $t3, 0x8002
...
/* 00CD94 7000C194 3C198002 */   lui   $t9, %hi(num_controller_plugged_in_flags) # $t9, 0x8002
/* 00CD98 7000C198 933968D0 */  lbu   $t9, %lo(num_controller_plugged_in_flags)($t9)
/* 00CD9C 7000C19C 3C0B8002 */  lui   $t3, %hi(pl1_controller_failure_lr) # $t3, 0x8002
...
/* 00CE1C 7000C21C 3C198002 */   lui   $t9, %hi(num_controller_plugged_in_flags) # $t9, 0x8002
/* 00CE20 7000C220 933968D0 */  lbu   $t9, %lo(num_controller_plugged_in_flags)($t9)
/* 00CE24 7000C224 3C0B8002 */  lui   $t3, %hi(pl1_controller_failure_ud) # $t3, 0x8002
...
/* 00CEA4 7000C2A4 3C198002 */   lui   $t9, %hi(num_controller_plugged_in_flags) # $t9, 0x8002
/* 00CEA8 7000C2A8 933968D0 */  lbu   $t9, %lo(num_controller_plugged_in_flags)($t9)
/* 00CEAC 7000C2AC 3C0B8002 */  lui   $t3, %hi(pl1_controller_failure_ud) # $t3, 0x8002
...
/* 00CF38 7000C338 3C088002 */  lui   $t0, %hi(num_controller_plugged_in_flags) # $t0, 0x8002
/* 00CF3C 7000C33C 910868D0 */  lbu   $t0, %lo(num_controller_plugged_in_flags)($t0)
/* 00CF40 7000C340 3C0C8002 */  lui   $t4, %hi(pl1_controller_failure_held) # $t4, 0x8002
...
/* 00CFD8 7000C3D8 3C088002 */  lui   $t0, %hi(num_controller_plugged_in_flags) # $t0, 0x8002
/* 00CFDC 7000C3DC 910868D0 */  lbu   $t0, %lo(num_controller_plugged_in_flags)($t0)
/* 00CFE0 7000C3E0 3C0C8002 */  lui   $t4, %hi(pl1_controller_failure_pressed) # $t4, 0x8002
...
/* 00D488 7000C888 3C188002 */  lui   $t8, %hi(controller_1_rumble_duration) # $t8, 0x8002
...
/* 00D4F0 7000C8F0 3C018002 */  lui   $at, %hi(controller_2_rumble_state) # $at, 0x8002
/* 00D4F4 7000C8F4 240F0001 */  li    $t7, 1
/* 00D4F8 7000C8F8 AC2F68EC */  sw    $t7, %lo(controller_2_rumble_state)($at)
/* 00D4FC 7000C8FC 3C018002 */  lui   $at, %hi(controller_2_rumble_pulse) # $at, 0x8002
/* 00D500 7000C900 AC20690C */  sw    $zero, %lo(controller_2_rumble_pulse)($at)
/* 00D504 7000C904 3C018002 */  lui   $at, %hi(controller_3_rumble_state) # $at, 0x8002
