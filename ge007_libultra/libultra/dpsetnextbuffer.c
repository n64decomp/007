...
#ifdef NONMATCHING
void osDpSetNextBuffer(s32 arg0, ? arg2, ? arg3, ? argA, s32 argC, u32 argD) {
    // Node 0
    ...
    DPC_STATUS_REG = 1;
    // Node 3
    if ((DPC_STATUS_REG & 1) != 0)
    {
        goto loop_3;
    }
    // Node 4
    *(void *)0xa4100000 = osVirtualToPhysical(argA);
    DPC_END_REG = (u32) (osVirtualToPhysical(argA) + argD);
    return;
